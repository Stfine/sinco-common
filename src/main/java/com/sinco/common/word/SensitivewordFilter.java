...
public class SensitivewordFilter {  
     ...
     * 构造函数，初始化敏感词库 
     */  
    public SensitivewordFilter(InputStream in) {  
        sensitiveWordMap = SensitiveWordInit.initKeyWord(in);
    }  
    ...
    public static void main(String[] args) throws IOException {  
        ...
        File file=new File("/Users/james/git/sinco-common/sinco-common/src/main/java/SensitiveWords.txt");
        
        SensitivewordFilter filter = new SensitivewordFilter(FileUtils.openInputStream(file));
